...
## Result-File is positioned in <Wildfly-Path>/bin/result/crawl

## Result-File naming: <subdomain_domain_tld_MM_DD_YYYY-HH_MM>
Example for 'pswengi.bamb.at' started crawling on 23.11.2015 15:13
...
1 Line: <URL>
	Example: http://pswengi.bamb.at
2 Line: Date and time of crawling the page
	Example: 'Sat Nov 23 14:21:53 CET 2015'
